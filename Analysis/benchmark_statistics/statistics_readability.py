...
for item in arxiv:
    if item["label"] == "llm":
        arxiv_list.append(textstat.flesch_reading_ease(item["text"]))
for item in xsum:
    if item["label"] == "llm":
        xsum_list.append(textstat.flesch_reading_ease(item["text"]))
for item in writing:
    if item["label"] == "llm":
        writing_list.append(textstat.flesch_reading_ease(item["text"]))
for item in review:
    if item["label"] == "llm":
        review_list.append(textstat.flesch_reading_ease(item["text"]))
...
for item in ChatGPT:
    if item["label"] == "llm":
        ChatGPT_list.append(textstat.flesch_reading_ease(item["text"]))
for item in Claude:
    if item["label"] == "llm":
        Claude_list.append(textstat.flesch_reading_ease(item["text"]))
for item in PaLM:
    if item["label"] == "llm":
        PaLM_list.append(textstat.flesch_reading_ease(item["text"]))
for item in Llama:
    if item["label"] == "llm":
        Llama_list.append(textstat.flesch_reading_ease(item["text"]))
...
for item in direct_prompt:
    if item["label"] == "llm":
        direct_prompt_list.append(textstat.flesch_reading_ease(item["text"]))
    elif item["label"] == "human":
        human_list.append(textstat.flesch_reading_ease(item["text"]))
for item in prompt_attacks:
    if item["label"] == "llm":
        prompt_attacks_list.append(textstat.flesch_reading_ease(item["text"]))
for item in paraphrase_attacks:
    if item["label"] == "llm":
        paraphrase_attacks_list.append(textstat.flesch_reading_ease(item["text"]))
for item in perturbation_attacks:
    if item["label"] == "llm":
        perturbation_attacks_list.append(textstat.flesch_reading_ease(item["text"]))
