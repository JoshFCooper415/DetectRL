...
axes[0].set_title('Text Length Distribution in Multi-Domain', fontsize=14)
...
sns.kdeplot(ChatGPT_lengths, color='#8ECFC9', label='ChatGPT', ax=axes[1])
sns.kdeplot(Claude_lengths, color='#FFBE7A', label='Claude', ax=axes[1])
sns.kdeplot(PaLM_lengths, color='#FA7F6F', label='PaLM', ax=axes[1])
sns.kdeplot(Llama_lengths, color='#82B0D2', label='Llama', ax=axes[1])
axes[1].set_title('Text Length Distribution in Multi-LLM', fontsize=14)
axes[1].set_xlabel('Text Length', fontsize=14)
...
sns.kdeplot(direct_prompt_lengths, color='#8ECFC9', label='Direct Prompt', ax=axes[2])
sns.kdeplot(prompt_attacks_lengths, color='#FFBE7A', label='Prompt Attack', ax=axes[2])
sns.kdeplot(paraphrase_attacks_lengths, color='#FA7F6F', label='Paraphrase Attack', ax=axes[2])
sns.kdeplot(perturbation_attacks_lengths, color='#82B0D2', label='Perturbation Attack', ax=axes[2])
sns.kdeplot(data_mixing_attacks_lengths, color='#BEB8DC', label='Data Mixing', ax=axes[2])
sns.kdeplot(human_lengths, color='#FFC0CB', label='Human', ax=axes[2])

axes[2].set_title('Text Length Distribution in Multi-Attack', fontsize=14)
